...
- Brief configuration guide: `./home-reference.nix` (this is a copy of the
  `home.nix` file generated by `home-manager init`)
- Home Manager manual: https://nix-community.github.io/home-manager/index.xhtml
- Configuration options: https://nix-community.github.io/home-manager/options.xhtml
- Nix flakes: https://nix.dev/manual/nix/2.28/command-ref/new-cli/nix3-flake.html
